...
export default function SignUpPage() {
  return (
    <div className="min-w-full min-h-screen relative bg-cover bg-center" >
      <div className={`mx-auto mt-[30%] md:mt-[5rem] md:ml-[26%] ml-[2.5rem] rounded-lg w-[90%] md:w-[100%] lg:w-[50%] md:h-[70vh] h-[30rem] justify-center relative z-10`}>
        <h1 className='text-center pt-[20%] font-bold text-lg text-blue-900 md:text-white'>SignUp</h1>
