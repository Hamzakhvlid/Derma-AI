...
//tailwind
const textstyle = "text-base text-gray-800 group-hover:text-white font-semibold";
const box = "flex mb-2 justify-start items-center gap-4 pl-5 hover:bg-[#007AFF] p-2 rounded-md group cursor-pointer hover:shadow-lg m-auto";
...
export default function SideNavbar() {
  return (
    <div>
        ...
        <div className="p-6 w-1/2 h-screen bg-white -z-2 relative top-20 -left-96 lg:left-0 lg:w-60  peer-focus:left-0 peer:transition ease-out delay-150 duration-200  shadow-lg ">
