  ...
  return (
    <section className="mt-16 " id="insurance">
      ...
      <div className="slider grid grid-cols-4 lg:grid-cols-8   shadow-md opacity-[100%] h-100 mx-auto overflow-hidden relative ">
        ...
        <div className="slide h-100 w-250">
          <img src={SANLAM.src} height="100" width="250" alt="" />
        </div>
        <div className="slide h-100 w-250">
          <img src={MMI.src} height="10" width="250" alt="" />
        </div>
        <div className="slide h-100 w-250">
          <img src={BRITAM.src} className="" alt="" />
        </div>
        <div className="slide h-100 w-250">
          <img src={SORAS.src} height="100" width="250" alt="" />
        </div>

        <div className="slide h-100 w-250">
          <img src={PRIME.src} height="100" width="250" alt="Prime Insurance" />
        </div>
        <div className="slide h-100 w-250">
          <img src={RADIANT.src} height="50" width="250" alt="" />
        </div>

        <div className="slide h-100 w-250">
          <img src={BK.src} height="100" width="250" alt="" />
        </div>
      </div>
    </section>
  );
